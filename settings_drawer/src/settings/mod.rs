...
impl Default for Modules {
    fn default() -> Self {
        Self {
            bluetooth: BluetoothModule { icon: BluetoothIconPaths { on: None, off: None, connected: None }, title: "Bluetooth".to_string() },
            ...
            auto_rotate: AutoRotateModule { icon: AutoRotateIconPaths { portrait: None, landscape: None }, title: "Auto Rotate".to_string() },
            settings: SettingsModule { icon: SettingsIconPaths { default: None }, title: "Settings".to_string() },
            running_apps: RunningAppsModule { icon: CommonLowMediumHighPaths {
                low: None,
                medium: None,
                high: None,
            },
            ...
            cpu: CpuModule { icon: CommonLowMediumHighPaths {
                low: None,
                medium: None,
                high: None,
            },
            ...
            memory: MemoryModule { icon: CommonLowMediumHighPaths {
                low: None,
                medium: None,
                high: None,
            },
            ...
            sound: SoundModule { icon: CommonLowMediumHighPaths {
                low: None,
                medium: None,
                high: None,
            },
            ...
            brightness: BrightnessModule { icon: CommonLowMediumHighPaths {
                low: None,
                medium: None,
                high: None,
            },
