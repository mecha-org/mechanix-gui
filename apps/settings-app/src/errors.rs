...
impl fmt::Display for SettingsAppErrorCodes {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            SettingsAppErrorCodes::ThemeReadError => write!(f, "ThemeReadError"),
            SettingsAppErrorCodes::ThemeParseError => write!(f, "ThemeParseError"),
            SettingsAppErrorCodes::CommandExecuteError => write!(f, "CommandExecuteError"),
        }
    }
}
