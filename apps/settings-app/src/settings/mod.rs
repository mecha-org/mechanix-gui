use crate::constants::{
     ABOUT_ICON, ADD_ICON, APPEARANCE_ICON, BACKGROUND_IMAGE, BACK_ICON, BASE_SETTINGS_PATH, BATTERY_ICON, BLUETOOTH_ICON, CONNECTED_ICON, DATE_TIME_ICON, DELETE_ICON, DEVICE_ICON, DISPLAY_ICON, GREY_RIGHT_ARROW, HOME_DIR_CONFIG_PATH, INFO_ICON, LANGUAGE_ICON, LOCK_ICON, SECURED_WIRELESS_ERROR, SECURED_WIRELESS_LOW, SECURED_WIRELESS_OFF, SECURED_WIRELESS_ON, SECURED_WIRELESS_STRONG, SECURED_WIRELESS_WEAK, SOUND_ICON, TICK_ICON, UPDATE_ICON, USR_SHARE_PATH, WHITE_RIGHT_ARROW, WIRELESS_ERROR, WIRELESS_GOOD, WIRELESS_LOW, WIRELESS_NOT_FOUND, WIRELESS_OFF, WIRELESS_ON, WIRELESS_SETTIGNS, WIRELESS_STRONG, WIRELESS_WEAK
};
