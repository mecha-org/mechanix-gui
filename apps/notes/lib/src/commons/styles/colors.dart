...
class NotesColors {
  ...
  static const Color floatingMenuColor = Color(0xFF48494B);
  static const Color scaffoldBackgroundColor = Color(0xFF131313);
  static const Color borderColor = Color(0xFF575757);
  static const Color searchBarColor = Color(0xFF363636);
  static const Color floatingToolbarcolor = Color(0xFF444444);
}
