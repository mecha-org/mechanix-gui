...
bool handleFormatByWrappingWithDoubleCharacter({
  ...
  } else if (formatStyle case DoubleCharacterFormatStyle.inline) {
    style = const InlineCodeAttribute();
  } else if (formatStyle case DoubleCharacterFormatStyle.underline) {
    style = const UnderlineAttribute();
  }
...
Attribute? _attributeForStyle(DoubleCharacterFormatStyle style) {
  switch (style) {
    case DoubleCharacterFormatStyle.underline:
      return Attribute.underline;

    case DoubleCharacterFormatStyle.strikethrough:
      return Attribute.strikeThrough;

    case DoubleCharacterFormatStyle.inline:
