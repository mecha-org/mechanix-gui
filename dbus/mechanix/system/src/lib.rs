...
/// Set the display brightness to the given value.
///
/// This function connects to the system bus and sends a D-Bus method call to the
/// `org.mechanix.services.Display` service, which sets the display brightness to
...
///
/// This function connects to the system bus and sends a D-Bus method call to the
/// `org.mechanix.services.Display` service, which returns the current display
