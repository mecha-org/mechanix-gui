//! # D-Bus interface proxy for: `org.mechanix.Notifications`
//!
//! This code was generated by `zbus-xmlgen` `5.1.0` from D-Bus introspection data.
//! Source: `Interface '/org/mechanix/Notifications' from service 'org.mechanix.Notifications' on system bus`.
//!
...
pub trait Notifications {
    ...
    /// NotificationReceived signal - now using Notification struct
    #[zbus(signal)]
