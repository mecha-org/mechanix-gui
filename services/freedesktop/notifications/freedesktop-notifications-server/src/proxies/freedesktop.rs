...
pub trait FreedesktopNotification {
    /// CloseNotification method
    pub fn close_notification(&self, id: u32) -> zbus::Result<()>;

    /// GetCapabilities method
    pub fn get_capabilities(&self) -> zbus::Result<Vec<String>>;

    /// GetServerInformation method
    pub fn get_server_information(&self) -> zbus::Result<(String, String, String, String)>;
    ...
    #[zbus(signal)]
    pub fn action_invoked(&self, id: u32, actionKey: &str) -> zbus::Result<()>;

    /// ActivationToken signal
    #[zbus(signal)]
    pub fn activation_token(&self, id: u32, activationToken: &str) -> zbus::Result<()>;
