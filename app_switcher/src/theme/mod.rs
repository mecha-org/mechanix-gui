...
impl Default for AppSwitcherTheme {
    fn default() -> Self {
        Self {
...
/// # Font Settings
/// 
/// Declares all the fonts needed for the app switcher with their 
...
/// # Reads Theme YML 
/// 
/// Reads the `settings.yml` and parsers to AppSwitcherTheme
/// 
/// **Important**: Ensure all fields are present in the yml due to strict parsing
pub fn read_theme_yml() -> Result<AppSwitcherTheme> {
    let mut file_path = PathBuf::from(std::env::var("MECHA_APP_SWITCHER_THEME_PATH")
