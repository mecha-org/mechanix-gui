...
use crate::{
    AirplaneMode, AirplaneModeEnabled, AutoRotation, Bluetooth, BluetoothEntry, BluetoothIcon,
    Brightness, ContainerNode, Microphone, MicrophoneEnabled, RotationEnabled, ScreenRecording,
    ScreenRecordingEnabled, Screens, SettingsDrawerRoot, SettingsItem, SettingsItemText,
    SettingsPanelBackgroud, SettingsPanelBackgroudEvent, Sound, StyledPopup, Wireless,
    WirelessEntry, WirelessIcon, divider, list_popup,
};
                    ...
                    .with_children(|parent| {
                        parent.spawn((
                            ...
                            (
                                ...
                                Button,
                                CoreButton::new().on_click(on_toggle_auto_rotation),
                            ),
                        ));
                        ...
                        parent.spawn((
                            ...
                            (
                                ...
                                BackgroundColor(NORMAL_BUTTON),
                                Button,
                                CoreButton::new().on_click(on_toggle_airplane_mode),
                            ),
                        ));
                        ...
                        parent.spawn((
                            ...
                            (
                                ...
                                BackgroundColor(NORMAL_BUTTON),
                                Button,
                                CoreButton::new().on_click(on_toggle_microphone),
                            ),
                        ));
                        ...
                        parent.spawn((
                            ...
                            (
                                ...
                                BackgroundColor(NORMAL_BUTTON),
                                Button,
                                CoreButton::new().on_click(on_toggle_screen_recording),
                            ),
                        ));
                    ...
                    .with_children(|parent| {
                        ...
                        parent.spawn((
                            ...
                            (
                                ...
                                BackgroundColor(NORMAL_BUTTON),
                                Button,
                                CoreButton::new().on_click(on_toggle_wireless),
                            ),
                        ));
