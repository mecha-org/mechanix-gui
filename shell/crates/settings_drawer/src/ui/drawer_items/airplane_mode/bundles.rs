...
use crate::{
    ...
    ui::{
        ButtonType2,
        drawer_items::airplane_mode::{AirplaneMode, AirplaneModeIcon},
        on_airplane_mode_click,
    },
};

pub fn airplane_mode(on_click: SystemId, icons: &SettingsDrawerIcons) -> impl Bundle {
    (
        Node {
        ...
        AirplaneMode,
        children![(
            ImageNode::new(icons.airplane_off.clone()),
            Node {
                width: Val::Px(40.),
                height: Val::Px(40.),
                ..default()
