...
use crate::{settings::{BatteryIconPaths, ChargingBatteryIconPaths}, types::BatteryLevel};
...
pub fn get_battery_icons_charging_map(icon_paths: ChargingBatteryIconPaths) -> HashMap<String, String> {
    let mut assets = HashMap::new();
