...
impl Default for Modules {
    fn default() -> Self {
        Self {
            home: HomeModule { title: "Home".to_string(), icon: None },
            settings: SettingsModule { title: "Settings".to_string(), icon: None },
            keyboard: KeyboardModule { title: "Keyboard".to_string(), icon: None },
        }
    }
}
